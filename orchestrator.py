...
SYSTEM_PROMPT = (
    ...
    "never attribute to the retrieved sources (or invent citations for) "
    "information they do not contain. If the question is NOT covered by the "
    "retrieved context, still answer it from your own engineering knowledge "
    "and clearly mark the answer as general knowledge, for example start with "
    "'From general engineering knowledge (not from the attached sources): '. "
    "Never reply just 'not in the sources' - always answer the question. Sections "
    "sized as \"200x300\" "
